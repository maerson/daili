...
class WiktionaryCrawler:
    ...
    def batch_download_words(self, words):
        ...
        for word_info in word_success:
            ...
            if word == 'aux':
                continue
            fw = open("d:\\enwiktionary\\"+self.json_output_path+"\\"+word+".json", 'w', -1, encoding="utf_8_sig")
...
def main(process_seq):
    ...
    v = WiktionaryCrawler(fs, "20200103-00-"+str(process_seq), int(process_seq), process_count)
    v.start()
